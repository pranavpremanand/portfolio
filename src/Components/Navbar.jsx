...
const Navbar = ({ toggleTheme, theme }) => {
  ...
  return (
    <>
      <div className="h-16 items-center justify-between w-full flex border border-x-0 border-gray-900 dark:border-gray-100 dark:bg-gray-900 dark:text-gray-50 text-gray-900 bg-gray-100 border-t-0">
        <div
          id="navbar"
