    ...
    >
      ...
      <div className="flex justify-center gap-5 px-1 lg:px-10 flex-wrap">
        {projects.map((project) => {
          return (
            <div className="w-full md:w-5/12 lg:w-4/12 mb-2">
              <div className="max-h-40 w-full overflow-hidden rounded-t-md">
                <img
                  className="object-cover w-full ease-in-out hover:scale-125 transition duration-700 cursor-pointer"
                  src={project.img}
                  alt=""
                />
                <hr />
              ...
              <div className="overflow-hidden w-full h-40 px-3 pt-3 flex flex-col bg-white rounded-b-md">
                <div className="w-full flex justify-between items-center">
                  <h3 className="text-lg md:text-xl mb-1 font-medium">
                    {project.title}
                  </h3>
                  <a href={project.link}><svg
