...
const Banner = () => {
  return (
    ...
    >
      <div className="absolute flex justify-start flex-col gap-1 sm:gap-2 items-center text-white bottom-14 sm:bottom-28">
        ...
        <TypeAnimation
          ...
          cursor={true}
          repeat={Infinity}
          className="text-xl sm:text-4xl font-medium inline-block"
        />
      </div>
